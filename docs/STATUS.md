...
## Open
- 2026-09-24 — SITE REVIEW WITH ANALYTICS (docs/audits/2026-09-24-site-review.md). The Sept 16-21 Instagram ad sent 1,023 phones to /schedule: 3.1s median, 1% tapped, 0 bookings. Live fixes shipped (d00901f, a532031, 3f4306b). Branch `dropin-finder` (b823e16, worktree ~/Code/dwd-website-finder) makes /schedule/ the drop-in page: WAITS FOR DIXON'S LOOK, then merge + shoot.js + live check. Also open: Collective has 3 waiting adult inquiries and no next date; Tori/John placeholder tiles on Teachers.
